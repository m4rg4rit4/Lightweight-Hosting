#!/bin/bash
# Autoupdate script for Lightweight-Hosting
...
echo -e "${YELLOW}Comprobando actualizaciones de Lightweight-Hosting...${NC}"
...
if [ "$LOCAL_VERSION" != "$REMOTE_VERSION" ]; then
    ...
    TEMP_INSTALL="/tmp/install_hosting_update.sh"
